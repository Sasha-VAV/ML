...
def main(user_query: str):
    ...
    llm_config = {
        "config_list": [{
            ...
            "base_url": "http://"+os.environ.get("IP")+":8000/v1",  # Replace with your local server address
    ...
    test_message = "Hello, can you hear me? This is a test message to check if the Mistral API is working."

    # Generate a response
    entrypoint_agent.initiate_chat(recipient=entrypoint_agent, message=test_message)
    response = entrypoint_agent.last_message()
    print(response)
