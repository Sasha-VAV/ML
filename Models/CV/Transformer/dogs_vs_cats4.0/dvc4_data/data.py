...
def load_data(
    ...
    """
    Function to load the training and testing dvc4_data
    :param path_to_train_data: string path to dvc4_train dvc4_data
    :param path_to_test_data: string path to dvc4_test dvc4_data
    :param train_batch_size: number of samples per dvc4_train batch
    :param test_batch_size: number of samples per dvc4_test batch
